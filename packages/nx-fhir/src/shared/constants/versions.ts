...
export const SUPPORTED_HAPI_VERSIONS = ['8.2.0', '8.4.0', '8.4.0-3', '8.6.0-1', '8.8.0-1', '8.10.0-1', '8.10.0-2', '8.10.0-3'];
...
export const HAPI_RELEASE_URLS: Record<string, string> = {
  ...
  '8.8.0-1':
    'https://github.com/hapifhir/hapi-fhir-jpaserver-starter/archive/refs/tags/image/v8.8.0-1.zip',
  '8.10.0-1':
    'https://github.com/hapifhir/hapi-fhir-jpaserver-starter/archive/refs/tags/image/v8.10.0-1.zip',
  '8.10.0-2':
    'https://github.com/hapifhir/hapi-fhir-jpaserver-starter/archive/refs/tags/image/v8.10.0-2.zip',
  '8.10.0-3':
    'https://github.com/hapifhir/hapi-fhir-jpaserver-starter/archive/refs/tags/image/v8.10.0-3.zip'
};
